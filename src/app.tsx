...
export function App() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState([
    'gabrielherera14@hotmail.com',
    'gabrielherera14@gmail.com'
  ])
        ...
        <div className='space-y-4'>
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              ...
              <button className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-500 transition-all'>
                Confirmar Viagem
                <ArrowRight className='size-5' />
              </button>
            </div>
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='flex flex-wrap gap-2'>
              {emailsToInvite.map(email => {
                return (
                  <div key={email} className='rounded-md bg-zinc-800 flex items-center gap-2 py-1.5 px-2.5'>
            ...
            <form onSubmit={addNewEmailToInvite} className='p-2.5 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2'>
              ...
              <button type='submit' className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-500 transition-all'>
                Convidar
